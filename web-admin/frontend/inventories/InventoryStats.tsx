...
import { Box, AlertTriangle, ShoppingBag, XCircle } from 'lucide-react';
    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
      ...
      <div className="bg-orange-50 p-5 rounded-xl border border-orange-100 shadow-sm flex items-center gap-4">
        ...
        <div>
          ...
          <h3 className="text-2xl font-bold text-gray-900">8 <span className="text-base font-medium text-gray-600">lô</span></h3>
        </div>
      </div>
      ...
      <div className="bg-red-50 p-5 rounded-xl border border-red-100 shadow-sm flex items-center gap-4">
        ...
        <div>
          ...
          <h3 className="text-2xl font-bold text-gray-900">2 <span className="text-base font-medium text-gray-600">lô</span></h3>
        </div>
      </div>
    </div>
  );
