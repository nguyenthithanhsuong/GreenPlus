...
export class GreenCreatorContentRepository {
  ...
  private mapPostRow(row: PostDbRow): GreenCreatorPostRow {
    ...
    return {
      post_id: row.post_id,
      user_id: row.user_id,
      author_name: this.pickUserField(row.author, "name"),
      author_image_url: this.pickUserField(row.author, "image_url"),
      title: row.title,
      content: row.content,
  ...
  private mapInteractionRow(row: {
    ...
    return {
      ...
      user_name: this.pickUserField(row.actor, "name"),
      user_image_url: this.pickUserField(row.actor, "image_url"),
